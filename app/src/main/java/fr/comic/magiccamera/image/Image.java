...
import fr.comic.magiccamera.io.BitmapIO;
...
public class Image {
     ...
     * See {@link fr.comic.magiccamera.util.Utils#calculateInSampleSize(int, int, int, int)}
    ...
    public boolean exportOriginalToGallery(Activity context, EffectProcessingHandler handler) {
        ...
        return BitmapIO.saveBitmap(result, "magic_camera", context);
    }

    public void setBitmap(Bitmap cropped) {
        this.bitmap = cropped;
    }
    ...
    public boolean exportToGallery(Activity context) {
        return BitmapIO.saveBitmap(this.getBitmap(), "magic_camera", context);
    }
