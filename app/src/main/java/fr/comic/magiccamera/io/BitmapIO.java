package fr.comic.magiccamera.io;
...
public class BitmapIO {
     ...
     * @return returns scaled bitmap, see {@link fr.comic.magiccamera.util.Utils#calculateInSampleSize(int, int, int, int)}
     */
     ...
     * @param reqWidth  The desired width for the image.
     * @param reqHeight The desired height for the image.
     * @return bitmap loaded and scaled from uri, see {@link fr.comic.magiccamera.util.Utils#calculateInSampleSize(int, int, int, int)}
     */
    ...
    public static boolean saveBitmap(Bitmap imgBitmap, String fileNameOpening, Context context){
        ...
        File saveDir =  new File(path + "/Magic Camera/");
